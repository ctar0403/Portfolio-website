        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            >
              ...
              <p className="text-muted-foreground text-center">
                Streamlining workflows with intelligent automation tools and AI-driven decision-making systems to boost productivity and efficiency.
              </p>
            </motion.div>
          </div>
      ...
      <section className="py-24">
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="max-w-3xl mx-auto text-muted-foreground">
              A curated stack of technologies I use to craft powerful web applications and tackle complex real-world challenges with elegant solutions.
            </p>
          </motion.div>
